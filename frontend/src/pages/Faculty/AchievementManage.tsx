...
export default function AchievementManage() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-2">Manage Alumni Achievements</h1>
      <p className="text-gray-600 mb-6">View and manage achievements submitted by alumni from your department</p>
