...
function AlumniDirectory() {
  ...
  const handleShare = (person: Alumni) => {
    if (navigator.share) {
      navigator.share({
        title: person.name,
        text: `Check out ${person.name} - ${person.current_position || 'Professional'} at ${person.current_company || 'Company'}`,
                  ...
                  <div className="p-6 flex flex-col items-center text-center relative">
                    ...
                    <div className="flex gap-3 w-full mt-auto">
                      ...
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gray-50 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors text-sm font-medium"
                      >
                        <Share2 size={16} />
                        Share
                      </button>
            ...
            <div className="flex justify-center mt-8">
              ...
              >
                {loadingMore ? (
                  ...
                  `Load More (${displayCount} of ${allAlumni.length})`
                )}
              </button>
            </div>
          )}
